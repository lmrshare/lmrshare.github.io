...
这个模型的作用就是把视觉和文本数据对应起来，该模型将图像和句子作为输入

position_c: [R-CNN、Fast R-CNN、Faster R-CNN](https://adeshpande3.github.io/adeshpande3.github.io/The-9-Deep-Learning-Papers-You-Need-To-Know-About.html)
