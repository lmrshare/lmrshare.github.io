...
简单来说GoogleNet更好的遵守了"Keep it deep, Keep it simple"。GoogleNet使用了22层CNN，其设计原则也颇为简单：堆叠卷积层和pooling层，同时作者也着重强调并处理了机器学习中的著名问题：“复杂模型下的计算复杂度问题以及overfitting”。
GoogleNet 引入了Inception module这一概念：


position: ["Inception Module"](https://adeshpande3.github.io/adeshpande3.github.io/The-9-Deep-Learning-Papers-You-Need-To-Know-About.html)
