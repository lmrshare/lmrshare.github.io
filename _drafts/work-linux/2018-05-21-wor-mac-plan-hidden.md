...
>* 把leetcode做过的题目整理成项目方便日后刷题, 然后开始快速复习到19:00, 并记录下复习进度, 19:00开始总结出信息学的所有题型, 然后指定后几天的刷题计划. 牛客100道面试题以C++为主, 如果有时间开始搜km文章以及活水岗位(1day)
>* crf11,15成文, 根据昨天计划刷leetcode题, 牛客复习昨天的题(2days)
