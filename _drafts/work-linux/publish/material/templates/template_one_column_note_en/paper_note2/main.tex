...
\author[1,*]{Mengran Lin}
%\author[2]{Bob Author}
%\author[1,2,+]{Christine Author}
%\author[2,+]{Derek Author}
\affil[1]{Chengdu R\&D Center, Tencent Technology Co.,Ltd, China}
%\affil[2]{Affiliation, department, city, postcode, country}
\affil[*]{mengranlin@tencent.com}
...
5.Inspiration or Un-tackled skills

6.Accumulation(especially the Discussion)

My summary(200 words)
\end{abstract}
\begin{document}
