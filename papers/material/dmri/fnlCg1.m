function x = fnlCg1(x0,problem, params)
%-----------------------------------------------------------------------
%
...
%
% Phi(x) = ||A*x - y||^2 + xfmWeight*(x'*W*x) + TVWeight*TV(x) 
%
%
...
function grad = gXFM(x,problem)
% compute gradient of the weighted L2 transform operator
grad = problem.W*x;
%grad = problem.W'*problem.W*x;
grad = 2*grad;
